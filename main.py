...
required_libraries = ["librosa", "pydub", "requests"]
act_req = ""
...
try:
    ...
    print(f"{Fore.RED}Can't install the library {actReq}: \nError {e}{Style.RESET_ALL}")
    input()
    exit(0)
...
# URL de descarga del archivo público compartido en Google Drive
